...
import { DEFAULT_LOCALE, getLocaleBlogPath, getLocalizedBlogPostPath } from '@/lib/i18n';
			...
			<div className="mx-auto flex min-h-[calc(100svh-128px)] max-w-6xl flex-col">
				...
				<div className="grid gap-10 border-t border-stone-300 pt-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
					<div className="max-w-4xl space-y-7">
						<p className="text-xs uppercase tracking-[0.3em] text-stone-500">AI 시대 개발자 노트</p>
						<h1 className="font-serif text-5xl leading-[0.92] text-stone-950 sm:text-7xl">
							에이전트가 코드를 쓰는 시대에, 개발자는 무엇을 더 잘해야 하는지 계속 생각하고
							있습니다.
						</h1>
						<p className="max-w-2xl text-base leading-7 text-stone-600 sm:text-lg">
							저는 요즘 개발자의 경쟁력이 구현 속도보다 문제 정의, 작업 분해, 명세, 그리고 결과를
							설명 가능한 형태로 만드는 데서 갈린다고 생각합니다. 이곳에는 개인의 사고를 더 또렷하게
							만들고, 그 또렷함이 팀의 병목을 어떻게 줄일 수 있는지에 대한 기록을 남기고 있습니다.
						</p>
					...
					<div className="space-y-7 lg:ml-auto lg:max-w-xl">
						...
						<Link
							href={getLocalizedBlogPostPath(DEFAULT_LOCALE, 'survivorship-bias-and-failure-hooks')}
