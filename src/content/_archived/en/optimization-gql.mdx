...
translationKey: 'optimization-gql'
...
Following the [transition to GraphQL](/en/blog/migrate-to-gql), the system gradually stabilized. As a result, issue reports started appearing through internal development channels and product team issue trackers.
